...
type GreetWithDeadlineReponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *GreetWithDeadlineReponse) Reset() {
	*x = GreetWithDeadlineReponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *GreetWithDeadlineReponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GreetWithDeadlineReponse) ProtoMessage() {}

func (x *GreetWithDeadlineReponse) ProtoReflect() protoreflect.Message {
	mi := &file_greet_greetpb_greet_proto_msgTypes[10]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GreetWithDeadlineReponse.ProtoReflect.Descriptor instead.
func (*GreetWithDeadlineReponse) Descriptor() ([]byte, []int) {
	return file_greet_greetpb_greet_proto_rawDescGZIP(), []int{10}
}

func (x *GreetWithDeadlineReponse) GetResult() string {
	if x != nil {
		return x.Result
	}
	return ""
...
var file_greet_greetpb_greet_proto_rawDesc = []byte{
	...
	0x74, 0x68, 0x44, 0x65, 0x61, 0x64, 0x6c, 0x69, 0x6e, 0x65, 0x52, 0x65, 0x70, 0x6f, 0x6e, 0x73,
	...
	0x68, 0x44, 0x65, 0x61, 0x64, 0x6c, 0x69, 0x6e, 0x65, 0x52, 0x65, 0x70, 0x6f, 0x6e, 0x73, 0x65,
...
var file_greet_greetpb_greet_proto_goTypes = []interface{}{
	...
	(*GreetWithDeadlineReponse)(nil), // 10: greet.GreetWithDeadlineReponse
}
var file_greet_greetpb_greet_proto_depIdxs = []int32{
	...
	10, // 14: greet.GreetService.GreetWithDeadline:output_type -> greet.GreetWithDeadlineReponse
...
func file_greet_greetpb_greet_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_greet_greetpb_greet_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GreetWithDeadlineReponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
