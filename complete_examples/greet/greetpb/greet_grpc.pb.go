...
type GreetServiceClient interface {
	...
	GreetWithDeadline(ctx context.Context, in *GreetWithDeadlineRequest, opts ...grpc.CallOption) (*GreetWithDeadlineReponse, error)
}
...
func (c *greetServiceClient) GreetWithDeadline(ctx context.Context, in *GreetWithDeadlineRequest, opts ...grpc.CallOption) (*GreetWithDeadlineReponse, error) {
	out := new(GreetWithDeadlineReponse)
...
type GreetServiceServer interface {
	...
	// Advanced gRPC Service Examples
	// Unary with Deadline Example
	GreetWithDeadline(context.Context, *GreetWithDeadlineRequest) (*GreetWithDeadlineReponse, error)
...
func (UnimplementedGreetServiceServer) GreetWithDeadline(context.Context, *GreetWithDeadlineRequest) (*GreetWithDeadlineReponse, error) {
